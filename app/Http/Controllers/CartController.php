...
class CartController extends Controller
{
    ...
    public function updateQuantity(Request $request, CartItem $cartItem): RedirectResponse
    {
        ...
        return redirect()->route('cart')->with('message', 'You have successfully changed the quantity of the product!');
    }
    ...
    public function removeItem(CartItem $cartItem): RedirectResponse
    {
        ...
        return redirect()->route('cart')->with('message', 'You have successfully removed the product from the cart!');
    }
}
